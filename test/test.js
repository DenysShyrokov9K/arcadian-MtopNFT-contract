...
describe("BallMtop", function () {
    ...
    before(async () => {
        ...
        payToken = await (await ethers.getContractFactory("BallMtop")).deploy()
    ...
    it('test_deposit_with_rightValue_then_success', async () => {
        ...
        await payToken.connect(signer3).mint({value: '1000000000000000000'});
        await payToken.connect(signer1).mint({value: '1000000000000000000'});
        await payToken.connect(signer4).mint({value: '1000000000000000000'});
